...
const ProjectCard = ({ title, description, tags, imageUrl, projectUrl }: ProjectCardProps, id: ProjectCardIndex) => {
    ...
    return (
        <motion.div style={{
            ...
            ref={ref}
        >
            <section ref={cardRef} className='relative bg-gray-100 max-w-[42rem] overflow-hidden border border-black/5 rounded-lg shadow-lg sm:pr-8 sm:h-[22rem] hover:bg-gray-200 transition-all group-even:sm:pl-4 dark:bg-white/10 dark:hover:bg-white/20 '>
                ...
                }} src={imageUrl} alt={title} quality={95} className='sm:absolute top-[5.7rem] sm:top-[5rem] -right-40 sm:w-[29.95rem] mx-auto sm:mx-0 w-[97.56%] h-[15rem] sm:h-[17rem] rounded-t-xl shadow-slate-950 shadow-2xl object-cover 
