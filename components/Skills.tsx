  ...
  return (
    <div className="relative max-w-[60rem]">
      ...
      >
        ...
        <motion.div className="w-full mx-auto grid grid-cols-2 md:grid-cols-4 justify-center items-center gap-8 md:gap-6" variants={fadeAnimation} initial='initial' animate='animate'>
